...
class CtrINVectorDBModel(BaseModel):
...
class ChatWithRAGModel(BaseModel):
    ...
    CtrINVectorDBModelConfig: CtrINVectorDBModel = Field(default=None, description="CtrINVectorDB模型")
